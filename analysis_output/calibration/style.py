...
# Residual plot tuning
RESIDUAL_NUM_BINS = 30
RESIDUAL_MIN_BIN_COUNT = 5
RESIDUAL_BAND_ALPHA = 0.18
RESIDUAL_MEAN_LINE_ALPHA = 0.45
RESIDUAL_SHOW_TRENDS = False
RESIDUAL_ROW_HEIGHT = 2.6
RESIDUAL_COL_WIDTH = 2.4
RESIDUAL_ROW_LABEL_X = -0.22
RESIDUAL_YLABEL_OFFSET = -0.13
RESIDUAL_WSPACE = 0.08
RESIDUAL_HSPACE = 0.12
CLASS_PANEL_WSPACE = 0.12
CLASS_PANEL_HSPACE = 0.25
RESIDUAL_TREND_MAX_POINTS = 250
RESIDUAL_TREND_SMOOTHING = 19
